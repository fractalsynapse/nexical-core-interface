...
views.generate(
    ...
    search_fields=["name"],
    view_fields=["id", "name", "created", "updated", "summary_model", "summary_persona", "format_prompt", "documents"],
    save_fields=["id", "name", "team", "summary_model", "summary_persona", "format_prompt", "documents"],
    view_relation_fields=["team", "documents"],
